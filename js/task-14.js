  ...
  items.forEach(item => {
    if (limit === 1) {
      if (item.classList.contains('box-1')) {
        item.classList.replace(`motion-move-1`, `motion-move-6`);
      }
      if (item.classList.contains('box-2')) {
        item.classList.replace(`motion-move-2`, `motion-move-1`);
      }
      if (item.classList.contains('box-3')) {
        item.classList.replace(`motion-move-3`, `motion-move-2`);
      }
      if (item.classList.contains('box-4')) {
        item.classList.replace(`motion-move-4`, `motion-move-3`);
      }
      if (item.classList.contains('box-5')) {
        item.classList.replace(`motion-move-5`, `motion-move-4`);
      }
      if (item.classList.contains('box-6')) {
        item.classList.replace(`motion-move-6`, `motion-move-5`);
      }
    }
    if (limit === 2) {
      if (item.classList.contains('box-1')) {
